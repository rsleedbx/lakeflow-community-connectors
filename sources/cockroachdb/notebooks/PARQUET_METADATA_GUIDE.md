...
```
{format}/{catalog}/{schema}/{timestamp}-...-{table}-...{ext}
```
...
path = "parquet/defaultdb/public/202512...usertable...parquet"
parts = path.split('/')

format = parts[0]      # "parquet"
catalog = parts[1]     # "defaultdb"  
schema = parts[2]      # "public"
filename = parts[3]    # "202512...usertable...parquet"
...
# JSON format  
json/defaultdb/public/202512191714242809831900000000000-...-usertable-1.ndjson
```
...
def extract_metadata_from_path(file_path: str) -> dict:
    """Extract catalog/schema/table from CDC file path."""
    # Example: "parquet/defaultdb/public/202512...usertable...parquet"
...
# Usage
file_path = "parquet/defaultdb/public/202512...usertable...parquet"
metadata = extract_metadata_from_path(file_path)
print(metadata)
# {'format': 'parquet', 'catalog': 'defaultdb', 'schema': 'public', 'table': 'usertable'}
```
...
### Path Organization
- Format: `{format}/{catalog}/{schema}/{timestamp}-{table}-{shard}.parquet`
...
**Hierarchy**: `format/catalog/schema/` structure for organization
